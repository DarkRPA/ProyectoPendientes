...
<body>
    ...
    <div class="texto">
        ...
        <form action="{{ route('instalador.verificacion') }}" method="post" enctype="multipart/form-data">
            @csrf
            <p>Introduzca el archivo CSV con los alumnos.<input type="file" name="csvAlumnos" id="" accept=".csv" required></p>
            <p>Introduzca el archivo CSV con los cursos<input type="file" name="csvCursos" id="" accept=".csv"></p>
